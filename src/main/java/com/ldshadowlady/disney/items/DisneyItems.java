...
public final class DisneyItems {
    ...
    public static final RegistryObject<Item> BAYMAX_HAT = REG.register("baymax_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> DONALD_HAT = REG.register("donald_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> GOOFY_HAT = REG.register("goofy_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> PLUTO_HAT = REG.register("pluto_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> POOH_HAT = REG.register("pooh_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> DAISY_HAT = REG.register("daisy_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> BAMBI_HAT = REG.register("bambi_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> FANTASIA_HAT = REG.register("fantasia_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> COCO_HAT = REG.register("coco_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> PATCH_HAT = REG.register("patch_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> ODDBALL_HAT = REG.register("oddball_hat", () -> new DisneyHatItem(ArmorMaterialList.disney, EquipmentSlotType.HEAD,(new Item.Properties()).group(ItemGroup.COMBAT)));
